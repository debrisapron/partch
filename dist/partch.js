;(function webpackUniversalModuleDefinition(root, factory) {
  ...
  else if (typeof exports === "object") exports["Partch"] = factory()
  else root["Partch"] = factory()
})(window, function () {
  ...
  \**********************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          "use strict"
          eval(
            '__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _Patch__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./Patch */ "./src/Patch.js");\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./helpers */ "./src/helpers.js");\n/* harmony import */ var _Adsr__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./Adsr */ "./src/Adsr.js");\n/* harmony import */ var _multiNodes__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./multiNodes */ "./src/multiNodes.js");\n/* harmony import */ var _nativeNodes__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./nativeNodes */ "./src/nativeNodes.js");\n/* harmony import */ var _noiseNodes__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./noiseNodes */ "./src/noiseNodes.js");\n/* harmony import */ var _Over__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./Over */ "./src/Over.js");\n/* harmony import */ var _Synth__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./Synth */ "./src/Synth.js");\n/* harmony import */ var _thirdPartyNodes__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./thirdPartyNodes */ "./src/thirdPartyNodes.js");\n\n\n\n\n\n\n\n\n\n\nfunction getDefaultAudioContext() {\n  return window.__partchAudioContext ||\n    (window.__partchAudioContext = new window.AudioContext())\n}\n\nfunction Partch(context = getDefaultAudioContext()) {\n  let _Patch = _Patch__WEBPACK_IMPORTED_MODULE_0__["default"].bind(null, context)\n  _Patch.context = context\n  _Patch.panic = _helpers__WEBPACK_IMPORTED_MODULE_1__["stopAllNodes"]\n  _Patch.load = (url) => Object(_helpers__WEBPACK_IMPORTED_MODULE_1__["loadAudioFile"])(context, url)\n  ;[_Adsr__WEBPACK_IMPORTED_MODULE_2__["default"], _Over__WEBPACK_IMPORTED_MODULE_6__["default"], _Synth__WEBPACK_IMPORTED_MODULE_7__["default"]]\n    .concat(Object.values(_multiNodes__WEBPACK_IMPORTED_MODULE_3__))\n    .concat(Object.values(_nativeNodes__WEBPACK_IMPORTED_MODULE_4__))\n    .concat(Object.values(_noiseNodes__WEBPACK_IMPORTED_MODULE_5__))\n    .concat(Object.values(_thirdPartyNodes__WEBPACK_IMPORTED_MODULE_8__))\n    .forEach((f) => _Patch[f.name] = f.bind(null, context))\n  return _Patch\n}\n\n/* harmony default export */ __webpack_exports__["default"] = (Partch);\n\n\n//# sourceURL=webpack://Partch/./src/index.js?'
          )
  ...
  \***************************/
        ...
        /***/ function (module, __webpack_exports__, __webpack_require__) {
          "use strict"
          eval(
            '__webpack_require__.r(__webpack_exports__);\n/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "Parallel", function() { return Parallel; });\n/* harmony import */ var _helpers__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./helpers */ "./src/helpers.js");\n/* harmony import */ var _Patch__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./Patch */ "./src/Patch.js");\n\n\n\nfunction Parallel(context, arrayOrFactory, length) {\n  let arr = Array.isArray(arrayOrFactory)\n    ? arrayOrFactory\n    : Object(_helpers__WEBPACK_IMPORTED_MODULE_0__["upTo"])(length).map(arrayOrFactory)\n\n  let connections = arr.map((__, i) => {\n    return `${arr[i].input ? \'in > \' : \'\'}${i} > out`\n  })\n  return Object(_Patch__WEBPACK_IMPORTED_MODULE_1__["default"])(context, arr, ...connections)\n}\n\n\n//# sourceURL=webpack://Partch/./src/multiNodes.js?'
          )
